  ...
  return (
    <div className={`flex h-screen w-auto flex-col p-5 min-h-screen ${isDarkTheme ? "bg-customGray" : "bg-customWhite"}`}>
      ...
      <div className="flex flex-col mb-5 w-full">
        ...
        <input
          type="text"
          className={`h-12 border placeholder-slate-500 ${isDarkTheme ? "border-customGray600 bg-gray-700 text-customWhite placeholder:text-#fff" : "border-customOrange bg-customOrange text-black placeholder:text-#555"} 
      ...
      <div className="flex flex-col mb-5 w-full">
        ...
        <textarea
          className={`h-64 border placeholder-slate-500 ${isDarkTheme ? "border-customGray600 bg-gray-700 text-customWhite placeholder:text-#fff" : "border-customOrange bg-customOrange text-black placeholder:text-#555"} 
      ...
      <button
        className={`h-12 flex justify-center items-center rounded-full transition duration-300 ease-in-out ${isDarkTheme ? "bg-gray-600 border-customWhite border hover:border-gray-400 hover:text-gray-400" : "bg-customOrange border hover:border-gray-800 hover:text-gray-800 hover:shadow-lg"} w-full 
