...
const Contacts = () => {
  ...
  return (
    <div
      className={`flex h-screen flex-col mx-auto mt-10 p-5 min-h-screen ${
        isDarkTheme ? "bg-rgba(18, 18, 18, 1)" : "bg-customWhite"
      }
    smallPhone:w-full
    phone:w-full
    table:w-1/2
    ...
    >
      <h1
        className={`text-2xl font-semibold mx-auto mb-8 ${
          isDarkTheme ? "text-customWhite" : "text-gray-800"
        }`}
      >
        Contacts
      </h1>
      ...
      <div className="flex flex-col mb-5 w-full">
        ...
        <input
          type="text"
          className={`h-12 border placeholder-slate-500 ${
            isDarkTheme
              ? "border-customGray600 bg-gray-700 text-customWhite placeholder:text-#fff"
              : "border-customLightGray bg-customLightGray primaryText placeholder:text-#555"
          } 
      ...
      <div className="flex flex-col mb-5 w-full">
        ...
        <textarea
          className={`h-64 border placeholder-slate-500 ${
            isDarkTheme
              ? "border-customGray600 bg-gray-700 text-customWhite placeholder:text-#fff"
              : "border-customLightGray bg-customLightGray primaryText placeholder:text-#222"
          } 
      ...
      <button
        className={`h-12 flex justify-center items-center rounded-full transition duration-300 ease-in-out ${
          isDarkTheme
            ? "bg-gray-600 border-customWhite border hover:border-gray-700 hover:text-gray-400"
            : "bg-customOrange border hover:border-gray-800 hover:text-gray-800 hover:shadow-lg"
        } w-full 
      ...
      >
        <span
          className={`text-lg ${
            isDarkTheme
              ? "text-customWhite hover:text-gray-400"
