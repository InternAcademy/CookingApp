  ...
  return (
    <div className={`${isDarkTheme ? "bg-customGray" : "bg-customWhite"} min-h-screen p-6`}>
      <div className="flex flex-col items-center">
        ...
        <div
          className={`w-full mb-6 pb-6 ${isDarkTheme ? "bg-gray-800" : "bg-gray-200"} rounded-xl py-4 px-4 
        ...
        web:py-8 web:px-8 web:text-base`}>
              ...
              {alergens.map((alergen, index) => (
                <button
                  ...
                  className={`border flex items-center rounded-full px-3 py-1 mx-1 mb-2 
                    ...
                    ${isDarkTheme ? "border-blue-500 text-blue-300 bg-gray-800 hover:bg-gray-700 shadow-xl hover:shadow-2xl" : "border-gray-300 bg-white text-black shadow-md hover:border-gray-400 hover:bg-gray-100 hover:shadow-lg"}`}>
                  {alergen}
          ...
          tablet:px-4 tablet:py-2 tablet:text-base 
          web:text-base
          ${isDarkTheme ? "border-gray-600 bg-gray-900 text-white" : "border-gray-300 bg-white text-black"}`}
          ...
          <button onClick={handleAddAlergen} className="w-full flex items-center justify-center mt-4 transition duration-300 ease-in-out">
            <div
              ...
              ${isDarkTheme ? "border-gray-600 text-white hover:border-gray-400 hover:text-gray-400 hover:shadow-lg" : "border-gray-300 hover:border-gray-800 hover:text-gray-800 hover:shadow-lg"}`}>
        ...
        <div
          ...
          ${isDarkTheme ? "bg-gray-800" : "bg-gray-200"} rounded-xl py-4 px-4
        ...
        web:py-8 web:px-8 web:text-base`}>
            ...
            <div className="flex flex-wrap mb-4">
              {foodPreferences.map((preference, index) => (
                <button
                  ...
                  className={`border flex items-center rounded-full px-3 py-1 mx-1 mb-2 ${isDarkTheme ? "border-blue-500 text-blue-300 bg-gray-800 hover:bg-gray-700 shadow-xl hover:shadow-2xl" : "border-gray-300 bg-white text-black shadow-md hover:border-gray-400 hover:bg-gray-100 hover:shadow-lg"}
                    phone:px-3 phone:py-1.5 phone:text-sm 
                    tablet:px-4 tablet:py-2 tablet:text-base
                    web:px-3 web:py-1 web:text-base
                    `}>
          ...
          <button onClick={handleAddFoodPreference} className="w-full flex items-center justify-center mt-2 transition duration-300 ease-in-out">
            <div
              className={`w-84 px-16 py-3 my-3 bg-customOrange rounded-full flex items-center justify-center border ${isDarkTheme ? "border-gray-600 hover:border-gray-400 hover:text-gray-400" : "border-gray-300 hover:border-gray-800 hover:text-gray-800 hover:shadow-lg"}
          ...
          <div className="mt-4">
            <select
              ...
              className={`border rounded-lg px-4 py-2 w-full ${isDarkTheme ? "border-gray-600 bg-gray-900 text-white" : "border-gray-300 bg-white text-black"}
        ...
        <button onClick={handleSavePreferences} className="w-full flex items-center justify-center mt-4 mb-8 transition duration-300 ease-in-out">
          <div
            className={`w-84 px-16 py-3 bg-green-500 rounded-full flex items-center justify-center border ${isDarkTheme ? "border-gray-600 hover:border-gray-400 hover:text-gray-400" : "border-gray-300 hover:border-gray-800 hover:text-gray-800 hover:shadow-lg"}
            phone:px-18 phone:py-3 phone:text-sm 
            tablet:px-20 tablet:py-3.5 tablet:text-base 
