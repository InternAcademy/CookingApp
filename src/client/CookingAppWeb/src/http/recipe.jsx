...
export async function getRecipes({ token, userId }) {
  const response = await fetch(`localhost:8001/recipes/${userId}`, {
    method: "GET",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json"
...
export async function getRecipeById({ token, recipeId }) {
  ...
  const response = await fetch(`localhost:8001/r/${recipeId}`, {
    method: "GET",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json"
...
export async function archive({ token, recipeId }) {
  const response = await fetch(`localhost:8001/archive/${recipeId}`, {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json"
...
export async function getArchivedRecipes({ token, userId }) {
  const response = await fetch(`localhost:8001/archived-recipes/${userId}`, {
    method: "GET",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json"
