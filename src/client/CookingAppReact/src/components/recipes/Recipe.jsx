...
export default function Recipe(){
    return (
        <section className="flex flex-col bg-white w-3/4 min-h-56 rounded-2xl pb-3">
            <img className="h-2/3 object-cover  rounded-t-2xl" src='https://popmenucloud.com/cdn-cgi/image/width%3D1200%2Cheight%3D1200%2Cfit%3Dscale-down%2Cformat%3Dauto%2Cquality%3D60/mbocpdne/1ed25fc7-72ab-4966-9922-ed5ec1d13fe0.jpg'></img>
