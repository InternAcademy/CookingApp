    ...
    return (
        <nav className="">
            <ul className={`flex flex-row w-full py-3 justify-between sticky`}>
                <li
                    className={`flex flex-row pl-6 items-center gap-2 ${sidebarOpen ? "hidden" : "visible"}`}
                >
                    <Bars3BottomLeftIcon
                ...
                <div
                    className={`flex flex-row pl-6 items-center gap-2 ${sidebarOpen ? "block" : "hidden"}`}
                >
                    <h2 className="font-semibold text-xl">Meal Master</h2>
                </div>
                <li
                    className={`right-0 sticky flex flex-row pr-10 items-center gap-5 ${recipesOpen ? "invisible" : "visible"}`}
                >
