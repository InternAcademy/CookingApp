...
export default function Layout() {
  ...
  return (
    <main
      className={`flex w-full max-h-dvh first-line:overflow-hidden ${theme === "Dark" ? "dark" : ""} ${theme === "Light" ? "light" : ""} ${theme !== "Dark" && theme !== "Light" ? theme.toLowerCase() : ""} bg-base overflow-x-hidden`}
    >
      <Sidebar />
