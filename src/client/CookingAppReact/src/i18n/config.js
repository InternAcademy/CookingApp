  ...
  resources: {
    ...
    bg: {
      translation: {
        ...
        DislikedFoods: "Неприятни храни",
        AddFood: "Добави храна",
        GeneratingMeal: "Генериране на храна",
        GenerateMeal: "Генерирай храна",
        GetPremium: "Стани премиум",
        MyMeals: "Моите храни",
        LoadMore: "Зареди още...",
        NoRecipes: "Нямате рецепти",
        Loading: "Зареждане",
        YourSubscription: "Вашата абонамент",
        Dashboard: "Табло",
        NoChats: "Нямате чатове",
        RulesNPolicies: "Правила и политики",
        Settings: "Настройки",
        Subscription: "Абонамент",
        SignOut: "Изход",
        Upload: "Качи",
        CopyUserId: "Копирай потребителски ID",
        Profile: "Профил",
        WhatToCook: "Какво искаш да готвиш днес?",
