    ...
    <FlatList
      ...
      renderItem={({ item }) => {
        switch (item.key) {
            ...
            return (
              <View style={tw`w-full mb-6 pb-6 ${isDarkTheme ? "bg-[#202020]" : "bg-zinc-200/50"} rounded-xl py-4 px-4`}>
                ...
                <Autocomplete
                  ...
                  inputContainerStyle={tw`border ${isDarkTheme ? "border-gray-600 bg-gray-800" : "border-gray-300 bg-white"} rounded-lg px-4 py-2 mb-2`}
                  listContainerStyle={tw`border ${isDarkTheme ? "border-gray-600 bg-gray-800" : "border-gray-300 bg-white"} rounded-lg`}
          ...
          case "foodPreferences":
            return (
              <View style={tw`w-full mb-6 pb-6 ${isDarkTheme ? "bg-[#2a2a2a]" : "bg-zinc-200/50"} rounded-xl py-4 px-4`}>
                ...
                <TextInput style={tw`border ${isDarkTheme ? "border-gray-600 bg-gray-800 text-white" : "border-gray-300 bg-white text-black"} rounded-lg px-4 py-2 mb-2`} placeholder="Add your disliked foods" placeholderTextColor={isDarkTheme ? "#A9A9A9" : "#A9A9A9"} value={foodPreferenceInput} onChangeText={setFoodPreferenceInput} />
                ...
                <View style={tw`mt-4`}>
                  <Picker selectedValue={selectedPreference} onValueChange={(itemValue, itemIndex) => setSelectedPreference(itemValue)} style={tw`border ${isDarkTheme ? "border-gray-600 bg-gray-800 text-white" : "border-gray-300 bg-white text-black"} rounded-lg`} dropdownIconColor={isDarkTheme ? "white" : "black"}>
                    <Picker.Item label="None" value="none" color={isDarkTheme ? "white" : "black"} />
                    <Picker.Item label="Vegetarian" value="vegetarian" color={isDarkTheme ? "white" : "black"} />
                    <Picker.Item label="Vegan" value="vegan" color={isDarkTheme ? "white" : "black"} />
                  </Picker>
                </View>
              </View>
            );
          case "saveButton":
            return (
              <View style={tw`w-full flex items-center mt-4 mb-8 ${isDarkTheme ? "bg-[#2a2a2a]" : "bg-white"}`}>
