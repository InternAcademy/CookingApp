...
const About = () => {
  ...
  return (
    <ScrollView
      style={tw`flex-1 p-6 ${isDarkTheme ? "bg-[#202020]" : "bg-white"}`}
    >
      <Text
        style={tw`text-2xl font-bold mb-4 ${isDarkTheme ? "text-orange-400" : "text-orange-500"}`}
      >
        About
      </Text>
      <Text
        style={tw`text-base leading-6 mb-5 ${isDarkTheme ? "text-white" : "text-black"}`}
      >
