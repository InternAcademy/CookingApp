  ...
  const updateProfile = async () => {
    try {
      const response = await fetch(
        "https://localhost:8001/api/update-profile",
        {
          method: "POST",
          headers: {
  ...
  return (
    <ScrollView style={tw`flex-1 ${isDarkTheme ? "bg-[#202020]" : "bg-white"}`}>
      <View style={tw`flex-1 items-center p-6`}>
        <Text
          style={tw`text-3xl font-bold mb-6 ${isDarkTheme ? "text-white" : "text-black"}`}
        >
          Profile Settings
        </Text>
        ...
        <View style={tw`w-full mb-6 items-center`}>
          ...
          <TouchableOpacity
            style={tw`bg-blue-500 rounded-full py-2 w-40 self-center`}
            onPress={pickImage}
          >
        ...
        <View style={tw`w-full mb-6`}>
          ...
          <TextInput
            ...
            onChangeText={setSubscriptionInfo}
          />
        </View>
        ...
        <View style={tw`w-full mb-6`}>
          ...
          />
          <TouchableOpacity
            style={tw`bg-blue-500 rounded-full py-2 mt-2 w-40 self-center`}
          >
            <Text style={tw`text-white text-center text-base font-medium`}>
              Update Password
            </Text>
        ...
        <View style={tw`w-full mb-6 flex-row justify-center items-center`}>
          <TouchableOpacity
            style={tw`bg-green-500 rounded-full py-2 px-4 mx-2`}
          ...
          <TouchableOpacity
            style={tw`bg-red-500 rounded-full py-2 px-4 mx-2`}
