...
const ProfileSettings = () => {
  ...
  const updateProfile = async () => {
    try {
      // Assuming your backend API endpoint is /api/update-profile
    ...
    <ScrollView style={tw`flex-1 ${isDarkTheme ? 'bg-[#202020]' : 'bg-white'}`}>
      <View style={tw`flex-1 items-center p-6`}>
        ...
        <View style={tw`w-full mb-6`}>
          ...
          <TouchableOpacity style={tw`bg-blue-500 rounded-full py-2`} onPress={pickImage}>
            <Text style={tw`text-white text-center text-base font-medium`}>Change Profile Picture</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={tw`w-full mb-6`}>
          <TouchableOpacity style={tw`bg-green-500 rounded-full py-2`} onPress={updateProfile}>
            <Text style={tw`text-white text-center text-base font-medium`}>Save Changes</Text>
          </TouchableOpacity>
        </View>
