...
const LandingPage = () => {
  ...
  return (
    <View style={tw`flex-1 ${isDarkTheme ? 'bg-[#202020]' : 'bg-yellow-500'} items-center justify-center p-94`}>
      <View style={tw`mb-8`}>
      ...
      <Text style={tw`text-lg ${isDarkTheme ? 'text-gray-400' : 'text-white'} text-center mb-8`}>Easy way to manage all your cooking tasks as easy as tapping your finger</Text>
