...
const Home = () => {
    ...
    <View style={tw`p-6`}>
      ...
      <View style={tw`flex-row justify-start items-center mt-0 pl-10`}>
        <Image
          ...
          style={tw`w-38 h-38 rounded-lg`}
        />
        <Image
          source={require("../assets/lava_cake2.jpg")}
          style={tw`w-38 h-38 rounded-lg ml-2`}
        />
      </View>
      <Text style={tw`mt-2 text-sm text-gray-600 pl-10`}>
        Here are some example pictures of Lava Cakes.
      </Text>
      <TouchableOpacity style={tw`flex-row items-center mt-2 pl-10`}>
        <Image
          source={require("../assets/heart.png")}
          style={tw`w-4 h-4 mr-1 tint-orange-500`}
        />
        <Image
  ...
  return (
    <View style={tw`flex-1 bg-white`}>
      ...
      />
      <View
        style={tw`flex-none flex-row items-center p-2 border-t border-gray-300 bg-white`}
      >
        ...
        <View
          style={tw`flex-1 flex-row items-center border border-gray-300 rounded-full px-4 mx-1 bg-amber-50`}
        >
